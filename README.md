...
- ⏭ **Phase 5D–5F** — chat-to-call handoff + lifecycle automation (5D); confirmation / delivery / RTO / reorder automation with rescue-discount flow + 50% cap enforcement in code (5E); approval-gated campaigns (5F).
