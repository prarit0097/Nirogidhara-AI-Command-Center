...
- ⏭ **Phase 5E–5F** — confirmation / delivery / RTO / reorder automation with rescue-discount flow + 50% cap enforcement in code (5E); approval-gated campaigns (5F).
