# Generated by Django 5.1.15 on 2026-05-13 11:26
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("payments", "0023_phase8e_real_customer_payment_order_pilot"),
    ...
    operations = [
        migrations.CreateModel(
            name="RazorpayRealCustomerPaymentOrderControlledMutationGate",
            fields=[
                (
                    "id",
                    models.BigAutoField(
                ...
                (
                    "real_customer_controlled_mutation_only",
        ...
        migrations.CreateModel(
            name="RazorpayRealCustomerPaymentOrderControlledMutationAttempt",
            fields=[
                (
                    "id",
                    models.BigAutoField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="payments.razorpayrealcustomerpaymentordercontrolledmutationgate",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            name="RazorpayRealCustomerPaymentOrderControlledMutationRollback",
            fields=[
                (
                    "id",
                    models.BigAutoField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="payments.razorpayrealcustomerpaymentordercontrolledmutationattempt",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["status", "-created_at"], name="payments_ra_status_1dfcd3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="razorpayrealcustomerpaymentordercontrolledmutationgate",
            index=models.Index(
                ...
                name="payments_ra_source__d15080_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="razorpayrealcustomerpaymentordercontrolledmutationgate",
            index=models.Index(
                fields=["selected_order_id_snapshot", "selected_payment_id_snapshot"],
                name="payments_ra_selecte_56c873_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="razorpayrealcustomerpaymentordercontrolledmutationattempt",
            index=models.Index(
                fields=["gate", "-created_at"], name="payments_ra_gate_id_c59e88_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="razorpayrealcustomerpaymentordercontrolledmutationattempt",
            index=models.Index(
                fields=["status", "-created_at"], name="payments_ra_status_414c3d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="razorpayrealcustomerpaymentordercontrolledmutationattempt",
            index=models.Index(
                ...
                name="payments_ra_target__c918bc_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="razorpayrealcustomerpaymentordercontrolledmutationrollback",
            index=models.Index(
                fields=["attempt", "-created_at"], name="payments_ra_attempt_7c48e9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="razorpayrealcustomerpaymentordercontrolledmutationrollback",
            index=models.Index(
                fields=["status", "-created_at"], name="payments_ra_status_0ddbba_idx"
            ),
        ),
    ]
