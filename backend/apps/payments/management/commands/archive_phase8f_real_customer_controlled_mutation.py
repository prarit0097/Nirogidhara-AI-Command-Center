...
Phase 8F - archive a gate. require_reason=True. Never mutates
business rows.
"""
...
class Command(BaseCommand):
    help = (
        "Phase 8F - archive a gate. require_reason=True. Never "
    ...
    def add_arguments(self, parser) -> None:
        parser.add_argument(
            ...
            type=int,
            required=True,
            help="Phase 8F gate id to archive.",
        )
        parser.add_argument(
            "--reason",
            type=str,
            required=True,
            help="Non-empty archive reason.",
        )
    ...
    def handle(self, *args, **options) -> None:
        ...
        report = archive_phase8f_real_customer_controlled_mutation(
        ...
        if options.get("json"):
            ...
            return
        self.stdout.write(
            self.style.MIGRATE_HEADING("Phase 8F archive")
        )
