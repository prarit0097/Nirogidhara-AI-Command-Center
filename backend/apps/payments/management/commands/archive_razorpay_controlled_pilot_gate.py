...
Phase 7B - archive a Controlled Pilot Execution Gate. Audit-only.
"""
...
class Command(BaseCommand):
    help = (
        "Phase 7B - archive a Controlled Pilot Execution Gate. No "
    ...
    def handle(self, *args, **options) -> None:
        ...
        report = archive_phase7b_controlled_pilot_gate(
            gate_id,
            archived_by=None,
