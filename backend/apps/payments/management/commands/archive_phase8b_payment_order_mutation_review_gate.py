"""``python manage.py archive_phase8b_payment_order_mutation_review_gate --gate-id N --reason "..." --json``."""
...
class Command(BaseCommand):
    help = (
        "Phase 8B — archive a review gate. Never calls a provider; "
    ...
    def handle(self, *args, **options) -> None:
        ...
        report = archive_phase8b_payment_order_mutation_review_gate(
        ...
        if report.get("ok"):
            ...
            self.stdout.write(
                self.style.SUCCESS(
                    f"Phase 8B gate archived gate_id={gate['id']} "
