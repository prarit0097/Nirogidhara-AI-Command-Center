"""``python manage.py reject_razorpay_payment_order_workflow_gate \\
    --gate-id <ID> --reason "..." --json``.

Phase 6Q — reject a workflow safety gate. Audit-only.
"""
...
class Command(BaseCommand):
    help = (
        "Phase 6Q — reject a workflow safety gate review. No real "
    ...
    def handle(self, *args, **options) -> None:
        ...
        report = reject_phase6q_payment_order_workflow_gate(
