"""``python manage.py reject_razorpay_sandbox_status_review --review-id <ID> --reason "..." --json``.

Phase 6O — mark a sandbox status review rejected. Never mutates
business tables; never calls Razorpay.
"""
...
class Command(BaseCommand):
    help = (
        "Phase 6O — reject a sandbox status review. No business "
