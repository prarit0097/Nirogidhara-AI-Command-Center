...
ICON_BY_KIND: dict[str, str] = {
    ...
    "razorpay.controlled_pilot_gate.readiness_inspected": "eye",
    "razorpay.controlled_pilot_gate.previewed": "eye",
    "razorpay.controlled_pilot_gate.prepared": "file-plus",
    "razorpay.controlled_pilot_gate.dry_run_passed": "check-circle",
    "razorpay.controlled_pilot_gate.dry_run_failed": "shield-off",
    "razorpay.controlled_pilot_gate.rollback_dry_run_passed": "check-circle",
    "razorpay.controlled_pilot_gate.rollback_dry_run_failed": "shield-off",
    "razorpay.controlled_pilot_gate.approved_for_phase7c_review": "check-circle",
    "razorpay.controlled_pilot_gate.rejected": "x-circle",
    "razorpay.controlled_pilot_gate.archived": "archive",
    ...
    # + Payment candidate; never executes; never calls a provider;
    # never sends WhatsApp; never mutates business rows; never
    # edits any .env file).
    "phase8e.pilot.readiness_inspected": "eye",
    "phase8e.pilot.previewed": "eye",
    "phase8e.pilot.prepared": "file-plus",
    "phase8e.pilot.candidate_selected": "user-plus",
    "phase8e.pilot.dry_run_passed": "check-circle",
    "phase8e.pilot.dry_run_failed": "shield-off",
    "phase8e.pilot.approved": "check-circle",
