...
- **VPS pytest stabilization (2026-05-04):** six small, surgical fixes that resolve all 8 remaining VPS test failures without touching production behaviour. **Phase 6N remains the latest completed phase. No Phase 6O implementation. No env / provider / business mutation changes.**
