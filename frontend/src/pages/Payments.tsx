  ...
  return (
    <>
      <PageHeader eyebrow="Operations" title="Payments"
        description="Razorpay & PayU reconciliation, advance ratio and refund queue. Mock UI — connect /api/payments later."
        actions={<Button className="bg-gradient-hero text-primary-foreground" onClick={() => toast.success("Payment link drafted")}><Send className="h-4 w-4 mr-1.5" />Generate link</Button>}
      />
