...
export const api = {
  ...
  getSaasRazorpayControlledPilotExecutionReadiness: () =>
    safeFetch<SaasRazorpayControlledPilotExecutionReadiness>(
      "/v1/saas/razorpay/controlled-pilot-execution-readiness/",
      () =>
        M.SAAS_RAZORPAY_CONTROLLED_PILOT_EXECUTION_READINESS as SaasRazorpayControlledPilotExecutionReadiness,
    ),
  getSaasRazorpayControlledPilotExecutionAttempts: (
    limit: number = 25,
  ) =>
    safeFetch<SaasRazorpayControlledPilotExecutionAttemptsResponse>(
  ...
  getSaasRazorpayCourierExecutionReadiness: () =>
    safeFetch<SaasRazorpayCourierExecutionReadiness>(
      "/v1/saas/delhivery/courier-execution-readiness/",
      () =>
        M.SAAS_RAZORPAY_COURIER_EXECUTION_READINESS as SaasRazorpayCourierExecutionReadiness,
    ),
  getSaasRazorpayCourierExecutionAttempts: (limit: number = 25) =>
    safeFetch<SaasRazorpayCourierExecutionAttemptsResponse>(
  ...
  getSaasPhase8BPaymentOrderMutationReviewReadiness: () =>
    safeFetch<SaasPhase8BPaymentOrderMutationReviewReadiness>(
      "/v1/saas/phase8/payment-order-mutation-review-readiness/",
      () =>
        M.SAAS_PHASE8B_PAYMENT_ORDER_MUTATION_REVIEW_READINESS as SaasPhase8BPaymentOrderMutationReviewReadiness,
    ),
  getSaasPhase8BPaymentOrderMutationReviewGates: (limit: number = 25) =>
    safeFetch<SaasPhase8BPaymentOrderMutationReviewGatesResponse>(
      `/v1/saas/phase8/payment-order-mutation-review-gates/?limit=${limit}`,
      () =>
        M.SAAS_PHASE8B_PAYMENT_ORDER_MUTATION_REVIEW_GATES as SaasPhase8BPaymentOrderMutationReviewGatesResponse,
    ),

  // ---------- Phase 8C - Controlled Real Payment -> Order Mutation ----------

  getSaasPhase8CPaymentOrderControlledMutationReadiness: () =>
    safeFetch<SaasPhase8CPaymentOrderControlledMutationReadiness>(
      "/v1/saas/phase8/payment-order-controlled-mutation-readiness/",
      () =>
        M.SAAS_PHASE8C_PAYMENT_ORDER_CONTROLLED_MUTATION_READINESS as SaasPhase8CPaymentOrderControlledMutationReadiness,
    ),
  getSaasPhase8CPaymentOrderControlledMutationGates: (
    limit: number = 25,
  ) =>
    safeFetch<SaasPhase8CPaymentOrderControlledMutationGatesResponse>(
  ...
  getSaasPhase8ERealCustomerPaymentOrderPilotReadiness: () =>
    safeFetch<SaasPhase8ERealCustomerPaymentOrderPilotReadiness>(
      "/v1/saas/phase8/real-customer-payment-order-pilot-readiness/",
      () =>
        M.SAAS_PHASE8E_REAL_CUSTOMER_PAYMENT_ORDER_PILOT_READINESS as SaasPhase8ERealCustomerPaymentOrderPilotReadiness,
    ),
  getSaasPhase8ERealCustomerPaymentOrderPilotGates: (
    limit: number = 25,
  ) =>
    safeFetch<SaasPhase8ERealCustomerPaymentOrderPilotGatesResponse>(
