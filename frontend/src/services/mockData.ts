...
const PHASE_7G_LIVE_GATE_COUNTS = {
  draft: 0,
  approved: 0,
  executed: 0,
  failed: 0,
...
export const SAAS_PHASE7G_LIVE_REAL_CUSTOMER_DISPATCH_GATES: Record<
  string,
  unknown
> = {
  phase: "7G-Live",
  counts: PHASE_7G_LIVE_GATE_COUNTS,
  items: [],
  frontendCanExecute: false,
  apiEndpointCanExecute: false,
  apiEndpointCanApprove: false,
...
export const CALLING_TEAM_LEADER_LATEST: Record<string, unknown> = {
...
export const CALLING_TEAM_LEADER_SNAPSHOTS: Record<string, unknown> = {
  items: [],
  total: 0,
  page: 1,
  pageSize: 30,
...
// Phase 12D — Tier-4 AI Calling Performance Dashboard mocks (camelCase to
// match the actual backend serializer output).

export const CALLING_CAMPAIGNS_RESPONSE: Record<string, unknown> = {
  count: 1,
  results: [
    {
      id: 1,
      ...
      maxLeads: 5,
      leadsSelectedCount: 5,
      leadsAttemptedCount: 5,
      callsAttempted: 5,
      callsDispatched: 4,
      callsSkipped: 1,
      aiAssistantIdLast4: "82ef",
      recordedSignoffWindowStartUtc: "2026-05-18T07:30:00Z",
      recordedSignoffWindowEndUtc: "2026-05-18T08:00:00Z",
      recordedSignoffWindowValid: true,
      preparedAt: "2026-05-18T07:33:24Z",
      approvedAt: "2026-05-18T07:35:00Z",
      executedAt: "2026-05-18T07:36:00Z",
      completedAt: "2026-05-18T08:05:00Z",
      cancelledAt: null,
      vapiModeAtExecute: "live",
      sandbox: false,
      createdAt: "2026-05-18T07:33:24Z",
    },
  ],
};

export const CALL_OUTCOMES_SUMMARY: Record<string, unknown> = {
  total: 5,
  pendingCount: 3,
  approvedCount: 0,
  appliedCount: 0,
...
export const CALL_OUTCOMES_RESPONSE: Record<string, unknown> = {
  count: 5,
  results: [
    {
      id: 1,
      ...
      detectedOutcome: "connected_converted",
      suggestedLeadStatus: "Payment Link Sent",
      confidence: "high",
      reviewStatus: "pending",
      evidence: {
        conversion_signals_found: ["haan", "link bhejo"],
        callback_signals_found: [],
        rejection_signals_found: [],
        transcript_line_count: 6,
      },
      scoringVersion: "deterministic_v1",
      classifiedAt: "2026-05-18T07:05:00Z",
      appliedAt: null,
      appliedBy: "",
      createdAt: "2026-05-18T07:05:00Z",
    },
    {
      id: 2,
      callId: "CL-DEMO-2",
      ...
      leadId: "LD-DEMO-2",
      currentLeadStatus: "Interested",
      detectedOutcome: "connected_callback",
      suggestedLeadStatus: "Callback Required",
      confidence: "medium",
      reviewStatus: "pending",
      evidence: {
        conversion_signals_found: [],
        callback_signals_found: ["abhi busy", "kal call karo"],
        rejection_signals_found: [],
        transcript_line_count: 4,
      },
      scoringVersion: "deterministic_v1",
      classifiedAt: "2026-05-18T07:06:00Z",
      appliedAt: null,
      appliedBy: "",
    ...
    },
    {
      ...
      leadId: "LD-DEMO-3",
      currentLeadStatus: "Interested",
      detectedOutcome: "connected_not_interested",
      suggestedLeadStatus: "Not Interested",
      confidence: "high",
      reviewStatus: "pending",
      evidence: {
        conversion_signals_found: [],
        callback_signals_found: [],
        rejection_signals_found: ["nahi chahiye"],
        transcript_line_count: 3,
      },
      scoringVersion: "deterministic_v1",
      classifiedAt: "2026-05-18T07:07:00Z",
      appliedAt: null,
      appliedBy: "",
      createdAt: "2026-05-18T07:07:00Z",
    },
  ],
};

export const POST_CALL_FOLLOWUPS_RESPONSE: Record<string, unknown> = {
  count: 4,
  results: [
    {
      id: 1,
      ...
      dispatchedAt: null,
      dispatchedBy: "",
      metadata: { template_name: "payment_reminder" },
      createdAt: "2026-05-18T08:30:01Z",
      updatedAt: "2026-05-18T08:32:00Z",
    },
    {
      id: 2,
      callOutcomeId: 2,
      ...
      dispatchedBy: "",
      metadata: {},
      createdAt: "2026-05-18T08:30:05Z",
      updatedAt: "2026-05-18T08:30:05Z",
    },
    {
      id: 3,
      callOutcomeId: 4,
      ...
      phoneLast4: "0004",
      followUpType: "payment_reminder",
      status: "needs_customer_setup",
      customerFound: false,
      phase7eGateId: null,
      operatorNote: "",
      dispatchedAt: null,
      dispatchedBy: "",
      metadata: { error: "no_customer_for_phone" },
      createdAt: "2026-05-18T08:30:10Z",
      updatedAt: "2026-05-18T08:30:11Z",
    },
    {
      id: 4,
      callOutcomeId: 5,
      ...
      dispatchedBy: "",
      metadata: {},
      createdAt: "2026-05-18T08:30:15Z",
      updatedAt: "2026-05-18T08:30:15Z",
    },
  ],
};

export const POST_CALL_FOLLOWUP_SUMMARY: Record<string, unknown> = {
  total: 4,
  byStatus: {
    pending: 2,
    gate_prepared: 1,
    dispatched: 0,
    needs_customer_setup: 1,
    skipped: 0,
    gate_prep_failed: 0,
    sandbox_skipped: 0,
  },
...
// ---------------------------------------------------------------------------
// Phase 16F — Controlled Internal Pilot Readiness + Dry Run (dev-only mocks).
// ---------------------------------------------------------------------------
...
export const PILOT_READINESS = {
  ...
  automationFlags: {
    ...
    whatsappAiAutoReplyEnabled: false,
    whatsappCallHandoffEnabled: false,
    whatsappLifecycleAutomationEnabled: false,
    whatsappRescueDiscountEnabled: false,
    whatsappReorderDay20Enabled: false,
    mcpEnabled: false,
  ...
  claimVault: { status: "warning", message: "Claim Vault contains demo-only seed(s).", demoCount: 8, total: 8 },
  teamRoles: { status: "pass", message: "Director/Admin operational role assigned.", assignedRoles: ["director_admin"] },
  dataCounts: { leads: 42, customers: 18, orders: 12, importedCampaigns: 1 },
  gates: [
    { key: "lead_customer_data", label: "Lead / Customer data ready", status: "pass", detail: "42 leads, 18 customers available." },
    { key: "calling_outcome_flow", label: "Calling outcome flow ready", status: "pass", detail: "Imported-campaign call-queue available." },
    { key: "order_creation", label: "Order creation ready", status: "pass", detail: "Internal order service available." },
    { key: "confirmation_flow", label: "Confirmation flow ready", status: "pass", detail: "Internal confirmation-outcome service available." },
    { key: "payment_readiness", label: "Payment readiness (live blocked)", status: "blocked", detail: "Razorpay mode=mock; live actions blocked." },
    { key: "shipment_readiness", label: "Shipment readiness (live blocked)", status: "blocked", detail: "Delhivery mode=mock; live AWB blocked." },
    { key: "delivery_rto_readiness", label: "Delivery / RTO tracking readiness", status: "pass", detail: "RTO board available; no live booking." },
    { key: "whatsapp_automation", label: "WhatsApp live automation blocked", status: "blocked", detail: "WhatsApp provider=mock; broad automation OFF." },
    { key: "vapi_ai_calling", label: "Vapi / AI calling blocked", status: "blocked", detail: "VAPI_MODE=mock; AI_CALLING_ENABLED=false." },
    { key: "claim_vault_seed", label: "Claim Vault production seed", status: "warning", detail: "Claim Vault contains demo-only seed(s)." },
    { key: "team_roles", label: "Required team roles assigned", status: "pass", detail: "Director/Admin operational role assigned." },
    { key: "safety_state", label: "Safety state (AI Paused / Sandbox OFF)", status: "pass", detail: "AI Paused=true, Sandbox ON=false, live actions locked=true." },
  ],
  blockedLiveActions: [
  ...
  items: [
    {
      ...
      status: "warning",
      resultSummary: "Pilot dry-run completed with 1 warning(s). All live provider actions remain blocked.",
      selectedLeadId: null,
...
export const AI_ACTION_QUEUE = {
  items: [
    {
      id: 1,
      sourceSuggestionId: 1,
      actionType: "create_qa_review_task",
      sourceType: "manual",
      sourceId: "",
      title: "QA review of compliance risk",
      description: "Internal QA review task generated from approved AI suggestion.",
      assignedTeam: "qa_compliance",
      priority: "high",
      ...
      appliedAt: null,
      resultPayload: {},
      safetySnapshot: { providerLiveActionsLocked: true, liveAutonomousExecutionLocked: true },
      events: [
        { id: 1, actionId: 1, eventType: "created", note: "Queued from approved AI suggestion.", actor: "director", createdAt: "2026-06-02T10:00:00Z" },
      ],
    },
    {
      id: 2,
      sourceSuggestionId: 2,
      actionType: "create_director_review_item",
      sourceType: "manual",
      sourceId: "",
      title: "Director review item",
      description: "Internal Director review item.",
      assignedTeam: "director_admin",
      priority: "normal",
      status: "applied_internal",
      providerActionAttempted: false,
      providerActionTaken: false,
      externalActionAllowed: false,
      externalActionTaken: false,
      ...
      updatedAt: "2026-06-02T09:45:00Z",
      appliedAt: "2026-06-02T09:45:00Z",
      resultPayload: { kind: "internal_action_record", providerActionsBlocked: true },
      safetySnapshot: { providerLiveActionsLocked: true, liveAutonomousExecutionLocked: true },
      events: [],
    },
  ],
...
export const AI_ACTION_SUMMARY = {
  statusCounts: {
    pending_internal_action: 1,
    applied_internal: 1,
    rejected: 0,
    cancelled: 0,
    failed: 0,
...
const _WORKBOARD_ITEMS = [
  {
    ...
    sourceId: "",
    title: "QA review of compliance risk",
    description: "Internal QA review task.",
    assignedTeam: "qa_compliance",
    priority: "high",
    status: "applied_internal",
    providerActionAttempted: false,
    ...
    appliedAt: "2026-06-03T10:10:00Z",
    department: "qa_compliance",
    workStatus: "in_progress",
    assigneeUser: "director",
    dueAt: "2026-06-05T10:00:00Z",
    slaStatus: "on_track",
    blockerReason: "",
    completedBy: null,
    completedAt: null,
    lastActivityAt: "2026-06-03T10:30:00Z",
    resultPayload: {},
    safetySnapshot: { providerLiveActionsLocked: true, liveAutonomousExecutionLocked: true },
    events: [],
    workEvents: [
      { id: 1, actionId: 1, eventType: "assigned", note: "", actor: "director", metadata: {}, createdAt: "2026-06-03T10:15:00Z" },
      { id: 2, actionId: 1, eventType: "started", note: "", actor: "director", metadata: {}, createdAt: "2026-06-03T10:30:00Z" },
    ],
  },
  {
    id: 2,
    sourceSuggestionId: 2,
    actionType: "create_calling_followup_task",
    sourceType: "manual",
    sourceId: "",
    title: "Calling follow-up",
    description: "Internal calling follow-up task.",
    ...
    appliedAt: "2026-06-03T09:10:00Z",
    department: "calling",
    workStatus: "blocked",
    assigneeUser: "director",
    dueAt: "2026-06-02T09:00:00Z",
    slaStatus: "overdue",
    blockerReason: "Awaiting customer callback",
    completedBy: null,
    completedAt: null,
    lastActivityAt: "2026-06-03T09:20:00Z",
    resultPayload: {},
    safetySnapshot: { providerLiveActionsLocked: true, liveAutonomousExecutionLocked: true },
    events: [],
    workEvents: [],
...
export const AI_WORKBOARD = {
  items: _WORKBOARD_ITEMS,
  total: _WORKBOARD_ITEMS.length,
  departments: [
  ...
  workStatuses: [
    "assigned", "blocked", "cancelled", "completed_internal", "in_progress",
    "rejected", "unassigned",
  ],
};

export const AI_WORKBOARD_SUMMARY = {
  total: 2,
  unassigned: 0,
  assigned: 0,
  inProgress: 1,
  ...
  byDepartment: { qa_compliance: 1, calling: 1 },
  providerActionsLocked: true,
  liveAutonomousExecutionLocked: true,
  noProviderActionTaken: true,
  phase: "16K",
...
export const AI_WORKBOARD_ATTENTION = {
