...
| [`FUTURE_BACKEND_PLAN.md`](FUTURE_BACKEND_PLAN.md) | Historical phased roadmap (Phase 12D-era SaaS runtime gate status preserved). **Current baseline is Phase 16C — production verified at `687ef41`; next planned is Phase 16D — Payment / Logistics Integration Hardening** (separate Director directive required). |
