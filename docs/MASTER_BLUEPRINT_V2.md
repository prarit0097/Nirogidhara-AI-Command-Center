...
| Completed phase range (historical — as of original revision) | Phase 1 → **Phase 12D** (Tier-2 AI agent layer 9A-9F complete; Phase 10A-10C payment-recovery workflow complete). **Current operational baseline is Phase 15M (foundation release freeze) — see `nd.md` head-of-file.** |
