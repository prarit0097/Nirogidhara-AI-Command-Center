...
> **Operational supersession note (Phase 16F — IMPLEMENTED + PUSHED to `origin/main`; VPS production verification pending).** This blueprint v2 reflects the project's strategic framing as of its original revision date below and contains historical Phase 12D / Phase 8F-era wording. **Current operational truth is [`../nd.md`](../nd.md) head-of-file.** The current operational baseline is **Phase 16F — Controlled Internal Pilot Readiness + End-to-End Dry Run** (internal/DB-only pilot readiness + dry-run engine reusing Phase 16E readiness; no live provider action), on top of **Phase 16E — Payment / Logistics Integration Hardening** (PRODUCTION VERIFIED at `36395f6`); **Phase 16D — Uploaded Customer Data Campaigns is verified at `c0be74a`**, **Phase 16C — Director Daily Briefing + Team Roles UI at `687ef41`**, and **Phase 16B — Customer Lifecycle UI Backbone at `00c3295`** (the Phase 15 safety shell remains frozen at commit `eefd8b3`). Where this blueprint and `nd.md` disagree on any operational detail, **`nd.md` wins** and the blueprint is the historical strategic mirror. Next planned work is **Phase 16G** (NOT started; separate Director directive required). This blueprint is not edited section-by-section as new phases ship; it is preserved as the strategic v2 snapshot.
...
| Completed phase range (historical — as of original revision) | Phase 1 → **Phase 12D** (Tier-2 AI agent layer 9A-9F complete; Phase 10A-10C payment-recovery workflow complete). **Current operational baseline is Phase 16F (Controlled Internal Pilot Readiness + End-to-End Dry Run, IMPLEMENTED + PUSHED; VPS verification pending) on top of Phase 16E (Payment / Logistics Integration Hardening, PRODUCTION VERIFIED at `36395f6`; Phase 16D `c0be74a`, Phase 16C `687ef41`, Phase 16B `00c3295` are earlier verified baselines) — see `nd.md` head-of-file.** |
