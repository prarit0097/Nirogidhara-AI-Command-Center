...
`PHASE6K_RAZORPAY_TEST_EXECUTION_ENABLED=false`. **Next planned:
Phase 6S — Limited Internal Live Payment → Dispatch Pilot
Planning (planning-only, not started).**
...
python -m pytest -q                    # 1315 tests today

# Frontend
cd frontend
npm install
npm run dev                            # http://localhost:8080
npm test                               # 50 tests today
