...
tests; 1474 backend + 60 frontend, all green.** Defaults
...
python -m pytest -q                    # 1474 tests today

# Frontend
cd frontend
npm install
npm run dev                            # http://localhost:8080
npm test                               # 60 tests today
